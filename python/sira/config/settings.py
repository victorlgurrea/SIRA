...
CMEMS_SST_CANT_LAT_MIN = _f("CMEMS_SST_CANT_LAT_MIN", "42.20")
CMEMS_SST_CANT_LAT_MAX = _f("CMEMS_SST_CANT_LAT_MAX", "44.50")
...
CMEMS_SST_ATL_LAT_MIN = _f("CMEMS_SST_ATL_LAT_MIN", "37.00")
CMEMS_SST_ATL_LAT_MAX = _f("CMEMS_SST_ATL_LAT_MAX", "42.30")
CMEMS_SST_ATL_LON_MIN = _f("CMEMS_SST_ATL_LON_MIN", "-10.95")
CMEMS_SST_ATL_LON_MAX = _f("CMEMS_SST_ATL_LON_MAX", "-8.00")
CMEMS_SST_ATL_PASO_DEG = _f("CMEMS_SST_ATL_PASO_DEG", "0.10")
