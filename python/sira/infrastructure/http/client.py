...
from sira.config.settings import AEMET_API_KEY, ALLOWED_HOSTS, DATA_DIR, DATA_FILE, HTTP_TIMEOUT
...
def read_dashboard() -> dict:
    ...
    if not data:
        return data
    from sira.services.overlays.sismo import read_test_overlays
    from sira.services.overlays.meteo_alerts import read_active_test_alerts
