...
from sira.config.settings import AEMET_API_KEY, FORECAST_DAYS, OPEN_METEO_WEATHER_URL, ZONA
from sira.infrastructure.http.client import fetch_aemet, fetch_json
from sira.infrastructure.geo.es import coords_municipio, municipio_por_id
from sira.infrastructure.sources.meteo.parse import (
    VACIO_METEO,
